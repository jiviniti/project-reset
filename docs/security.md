...
The active journey no longer generates a share card. The retained internal concept route renders only local sample data and does not upload personalized files.
