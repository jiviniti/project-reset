    ...
    <main className="experience">
      <div className="phone-shell privacy-page">
        <header className="privacy-page__header">
          <ResetBrand />
          <p className="eyebrow eyebrow--accent">Privacy update</p>
          <h1>Privacy at Project <BrandedReset /></h1>
        </header>
        <section className="privacy-page__content">
          <h2>Project <BrandedReset /> is currently in beta.</h2>
          ...
          <Link className="button button--coral" href="/">
            <span>Return to Project <BrandedReset /></span>
