      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", padding: "64px 72px" }}>
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between" }}>
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            <div style={{ display: "flex", alignItems: "baseline", fontSize: 82, fontWeight: 700, letterSpacing: -6 }}>
              <span style={{ color: "#fa8757" }}>re</span>
              <span>set</span>
              <span style={{ color: "#fa8757" }}>.</span>
            </div>
            <span style={{ color: "#edbaa6", fontSize: 22 }}>Choose Better. Together.</span>
          </div>
          <div style={{ display: "flex", flexDirection: "column", paddingLeft: 34, borderLeft: "2px solid #edbaa6" }}>
            ...
            <span style={{ marginTop: 9, color: "#edbaa6", fontSize: 21 }}>A Survivor’s Guide</span>
          </div>
        </div>
        <div style={{ flex: 1, display: "flex", alignItems: "flex-end", justifyContent: "space-between" }}>
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            <span style={{ marginTop: 18, color: "#edbaa6", fontSize: 25 }}>Add your voice to the community picture.</span>
          </div>
          <div style={{ width: 110, height: 110, display: "flex", borderRadius: 999, background: "#fa8757" }} />
        </div>
      </div>
    </div>,
    size,
