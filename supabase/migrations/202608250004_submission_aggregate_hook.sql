-- Milestone 2: keep raw persistence and aggregate mutation in one transaction.
-- The helper is idempotent and reads allowlisted selections only; free text is excluded.
